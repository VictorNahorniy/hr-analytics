...
@Entity
@Table(name = "psychiatrist_certificate", schema = "hr_employeedb", catalog = "")
public class PsychiatristCertificate {
    ...
    public boolean equals(Object o) {
        ...
        PsychiatristCertificate that = (PsychiatristCertificate) o;
